 ...
 * @author Nam Anh
 */
public class EditSpFrame extends javax.swing.JFrame {
    DefaultTableModel tableModel;
    SanPham kh = SanPhamPanel.s;
     ...
     * @param khPanel
     */
    public EditSpFrame(JFrame parentFrame, SanPhamPanel khPanel) {
        ...
        cbLoai.setSelectedItem(kh.getLoai());
        txtHang.setText(kh.getHang());
        txtMota.setText(kh.getMota());
        txtGia.setText(Double.toString(kh.getGia()));    
        txtBh.setText(Double.toString(kh.getBaohanh()));
    }
    private void showStudent() {
        ...
        khList.forEach(k -> {
            tableModel.addRow(new Object[] {tableModel.getRowCount() + 1, k.getId(),k.getTen(),
                k.getLoai(), k.getHang(), k.getMota(), k.getGia(), k.getBaohanh()});
        });
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Chỉnh sửa thông tin sản phẩm", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14))); // NOI18N
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        kh.setTen(txtFullName.getText());
        kh.setLoai(cbLoai.getSelectedItem().toString());
        
        kh.setHang(txtHang.getText());
        ...
        try {
                ...
                kh.setGia(gia);
                try {
                    double bh = Double.parseDouble(txtBh.getText());
                    kh.setBaohanh(bh);
                    SanPhamCtrl.update(kh);
